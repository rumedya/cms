<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">
            Referans Listesi
            <a href="<?php echo base_url("references/new_form"); ?>" type="button" class="btn pull-right btn-primary btn-xs btn-outline"><i class="fa fa-plus"></i> Yeni Ekle</a>
        </h4>
...
<!--                             alt="" class="img-rounded">-->
                    ...
                    <td class="w135">
                        ...
                        <a href="<?php echo base_url("references/update_form/$item->id"); ?>" type="button" class="btn btn-info btn-xs btn-outline"><i class="fa fa-pencil"></i> Düzenle</a>
                    </td>
                </tr>
